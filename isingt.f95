...
REAL*8 :: x,y,rnlt,av,w,l,avv,T,avm,avg,cv,chi,q,pop,average,saverage,meen,smeen,maverage,msaverage,mmean,msmean,ol
Integer::i,j,p,ngbr(4),sa,sb,ra,rb,s,r,de,sums,suma,d,g,h,u,v,z,summ,sumn,po,n,b,it
saverage = 0.0
average = 0.0
maverage = 0.0
msaverage = 0.0
